...
We alllow for a lot of input forgiveness to ensure that erroroneous inputs
entered under stress do not crash the programme and cause more time to be
wasted. We also do not discriminate between capitalisation or wire colour
ordering.

We also modify the progression of the manual - we first ask for all
possible useful properties of the bomb first, rather than at cutting point,
to save on time, make questioning more efficient, and save working memory.
"""
...
def complicated_wires(lights, colour, star,
    ...
    if (lights == "NO" and colour == "WHITE" and star == "NO"):
        return "Cut the wire."
    if (lights == "NO" and (colour == "RED" or colour == "RED WHITE"
                            or colour == "WHITE RED" or colour == "BLUE"
                            or colour == "WHITE BLUE"
                            or colour == "BLUE WHITE" or colour == "RED BLUE"
                            or colour == "BLUE RED")
    ...
    if (lights == "NO" and (colour == "WHITE" or colour == "RED"
                             or colour == "RED WHITE" or colour == "WHITE RED")
        and star == "YES"):
        return "Cut the wire."
    if (lights == "NO" and (colour == "RED BLUE" or colour == "BLUE RED")
        and star == "YES" and parallel_port == "YES"):
        return "Cut the wire."

    # All light on and no star scenarios.

    if (lights == "YES" and (colour == "RED" or colour == "RED WHITE"
                             or colour == "WHITE RED")
        and star == "NO" and batteries >= 2):
        return "Cut the wire."
    if (lights == "YES" and (colour == "BLUE" or colour == "BLUE WHITE"
                             or colour == "WHITE BLUE")
        and star == "NO" and parallel_port == "YES"):
        return "Cut the wire."
    if (lights == "YES" and (colour == "RED BLUE" or colour == "BLUE RED")
        and star == "NO" and is_serial_even == "YES"):
        return "Cut the wire."

    # All light on and star scenarios.

    if (lights == "YES" and (colour == "WHITE" or colour == "RED"
                             or colour == "RED WHITE" or colour == "WHITE RED")
        and star == "YES" and batteries >= 2):
        return "Cut the wire."
    if (lights == "YES" and (colour == "BLUE" or colour == "WHITE BLUE"
...
while True:
 ...
 Please try again: """.replace("\n", "")).upper()
    ...
    while not(star in star_existence):
        star = input("""You've made a typo - the answer to \"Is there a star?\"
 is yes or no. Please try again: """.replace("\n", "")).upper()
