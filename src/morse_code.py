...
initial part of the morse code needs to be fully correct.  The
programme will then suggest possible correct frequencies.  If enough
lives are available, then all of them can be attempted.  Otherwise,
more correct morse code will need to be appended.
"""

# These dictionaries contain all of the possible morse code, words
# and frequencies.
...
# This function returns the possible frequencies corresponding to the
# morse code.
...
# This forgiving section asks the user for morse code.
while True:
